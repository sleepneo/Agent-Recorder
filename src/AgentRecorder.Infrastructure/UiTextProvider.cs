...
public sealed class UiTextProvider : IUiTextProvider
{
    ...
    private static Dictionary<string, string> CreateZhCn()
    {
        return new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["Confirmation_Info_Countdown"] = "开始前倒计时",
            ["Confirmation_Info_Countdown_Seconds"] = "{0} 秒",
            ["Confirmation_Info_Countdown_Off"] = "关闭",
            ["Confirmation_Info_Audio"] = "麦克风",
            ["Confirmation_Info_SystemAudio"] = "系统声音",
            ["Confirmation_Info_SystemAudioOn"] = "系统声音：开启（默认系统输出：{0}）",
            ["Confirmation_Info_SystemAudioSelectedOn"] = "系统声音：开启（所选系统输出：{0}）",
            ...
            ["Confirmation_Info_Mode"] = "模式",
            ["Confirmation_Info_Interval"] = "截图间隔",
            ["Confirmation_Info_Bound"] = "截图上限",
            ["Confirmation_Info_PlannedFrames"] = "计划截图数",
            ["Confirmation_Info_OutputKind"] = "输出格式",
            ["Confirmation_Info_OutputDirectory"] = "输出目录",
            ["Confirmation_Value_ScreenshotSeries"] = "截图序列",
            ["Confirmation_Value_PngSequence"] = "PNG 图片序列",
            ...
            ["Tray_RecordingFailure_DisplayUnavailableBody"] = "目标显示器已断开或不可用；录制已停止，未保存最终视频。",
            ...
            ["Indicator_ScreenshotSeries"] = "截图 {0}/{1}",
    ...
    private static Dictionary<string, string> CreateEnUs()
    {
        return new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["Confirmation_Info_Countdown"] = "Pre-capture countdown",
            ["Confirmation_Info_Countdown_Seconds"] = "{0} seconds",
            ["Confirmation_Info_Countdown_Off"] = "Off",
            ["Confirmation_Info_Audio"] = "Microphone",
            ["Confirmation_Info_SystemAudio"] = "System audio",
            ["Confirmation_Info_SystemAudioOn"] = "System audio: On (Default output: {0})",
            ["Confirmation_Info_SystemAudioSelectedOn"] = "System audio: On (Selected output: {0})",
            ...
            ["Confirmation_Info_Mode"] = "Mode",
            ["Confirmation_Info_Interval"] = "Screenshot interval",
            ["Confirmation_Info_Bound"] = "Screenshot bound",
            ["Confirmation_Info_PlannedFrames"] = "Planned screenshots",
            ["Confirmation_Info_OutputKind"] = "Output format",
            ["Confirmation_Info_OutputDirectory"] = "Output directory",
            ["Confirmation_Value_ScreenshotSeries"] = "Screenshot series",
            ["Confirmation_Value_PngSequence"] = "PNG image sequence",
            ["Confirmation_Value_NA"] = "N/A",
            ...
            ["Tray_RecordingFailure_DisplayUnavailableBody"] = "The target display was disconnected or became unavailable; recording stopped and no final video was saved.",
            ...
            ["Indicator_Countdown"] = "{0}",
            ["Indicator_ScreenshotSeries"] = "SHOT {0}/{1}",
