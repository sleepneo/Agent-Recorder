...
.PARAMETER Version
    Version string for the zip name. Default: v0.1.5
...
if ($versionResult.ExitCode -ne 0 -or $normalizedVersion -cne "wgc-native-helper 0.1.0`n") {
    throw "WGC helper --version smoke failed or returned an incompatible contract."
}
Write-Host "[OK] Native tests passed and helper version is wgc-native-helper 0.1.0" -ForegroundColor Green
